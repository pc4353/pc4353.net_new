...
<tr>
	...
	<td<?= $erName ?>><input type="text" value="<?= $name ?>" name="name" id="name" maxlength="20" size="40" style="height:25px;" ></td>
</tr>
<tr>
	<th>フリガナ<span class="red">必須</span></th>
	<td<?= $erKana ?>><input type="text" value="<?= $kana ?>" name="kana" id="kana" maxlength="20" size="40" style="height:25px;"></td>
</tr>
<tr>
	<th>電話番号（携帯可）<span class="red">必須</span></th>
	<td<?= $erPhone ?>><input type="text" value="<?= $phone ?>" name="phone" id="phone" maxlength="15" size="30" style="height:25px;"></td>
</tr>
<tr>
...
<tr>
	<th>ご住所</th>
	<td><input type="text" value="<?= $address ?>" name="address" maxlength="120" size="60" style="height:25px;"></td>
</tr>
<tr>
...
?>
<input type="text" value="<?= $other ?>" name="other" maxlength="100" size="40" style="height:20px;" /></td>
</table>
