...
<table class="about">
<tr>
	<th width="30%">お問い合わせ内容<span class="red">※</span></th>
...
<tr>
	<th>電話番号（携帯可）<span class="red">※</span></th>
	<td<?= $erPhone ?>><input type="text" value="<?= $phone ?>" name="phone" id="phone" maxlength="15" size="30"></td>
</tr>
<tr>
	<th>メールアドレス<span class="red">※</span></th>
	<td<?= $erMail ?>><input type="text" value="<?= $mail ?>" name="mail" id="mail" maxlength="100" size="40"></td>
</tr>
<tr>
	<th>ご住所</th>
...
<tr>
	...
	<td><label><input type="radio" value="通っていない" name="member"<? if( $member == "通っていない" ) { echo " checked"; } ?>>通っていない</label><br />
		<label><input type="radio" value="現在受講中" name="member"<? if( $member == "現在受講中" ) { echo " checked"; } ?>>現在受講中</label> <input type="text" value="<?= $room1 ?>" name="room1" maxlength="40" size="20">教室<br />
		<label><input type="radio" value="卒業している" name="member"<? if( $member == "卒業している" ) { echo " checked"; } ?>>卒業している</label> <input type="text" value="<?= $room2 ?>" name="room2" maxlength="40" size="20">教室<br />
