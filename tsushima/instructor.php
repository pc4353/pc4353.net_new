...
$ary = array(
	array(
		...
		"ワード・iPhone",
		"ネット検索・動画視聴",
		"やりたいと思った時が始め時！！<br />津島教室では、中学生のお子さんから80代の方まで幅広い年代の皆さんに学んでいただいてます。<br />最近では働き方改革で仕事活用の方が増え、資格取得の為に皆さん日々励んでいらっしゃいます。パソコン教室ですがタブレットやスマートフォンの講座も楽しく学べるようになっています。インストラクター一同真摯に取り組んで参りますので是非一度教室へお越し下さいませ。"
	),
	array(
		"伊藤（愛） 先生",
		"ワード・タイピング",
