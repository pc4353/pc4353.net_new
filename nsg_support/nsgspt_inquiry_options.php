...
========================================*/
function inputHTML() {
global $erBase, $erAttendcode, $erName, $erKana, $erMail, $erCourse;
global $base, $attendcode, $name, $kana, $mail, $course, $question;
?>
<table class="about">
<tr>
...
<tr>
	...
	<td<?= $erCourse ?>><ul>
    <li><label><input type="radio" class="nBn" value="その他" name="course"<? if( $course == "その他" ) { echo " checked"; } ?>> その他</label></li>
