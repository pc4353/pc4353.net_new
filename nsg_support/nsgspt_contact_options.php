...
/* 送付先アドレス */
define( "CONTACT_MAIL_TO_1", "nsg0088@cheery.co.jp" );
...
========================================*/
function inputHTML() {
global $erBase, $erName, $erKana, $erZip, $erAddrs, $erPhone, $erMail, $erCourse;
global $base, $name, $kana, $zip, $addr, $addrs, $phone, $mail, $course, $question;
?>
<table class="about">
<tr>
...
<tr>
	...
	<td<?= $erZip ?>><input type="tel" name="zip" value="<?= $zip ?>" placeholder="　" maxlength="15" size="8">　<br class="sp-only">【入力すると住所が自動入力されます】<br />例）1000001</td>
</tr>
<tr>
