...
$ary = array(
	...
	array(
		...
		"タイピング・チャット",
		"ゲーム",
		"パソコンやタブレット、スマートフォンを使っていてお困りのことはありますか？<br />ぜひ教室にきてその困っていることを教えてください。<br />そのお困り事を解決するための最善の講座を提案していきます。<br />まだオープンして間もないプライムツリー赤池の３階に、教室はあります。<br />教室でお勉強したあとは、フードコートでおいしい物を食べて、鋭気を養ってください！！",
	)
);
?>
