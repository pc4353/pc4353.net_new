...
$ary = array(
	array(
		...
		"ワード・エクセル・タイピング",
		"ゲーム・ポスター(掲示)作成",
		"パソコンが苦手な方も、パソコンを触る事が楽しくなるように。スキルアップの方は目標を達成できるように。私たちと一緒に頑張りましょう！",
	),
	array(
		"奥村 先生",
		"ワード・ネット活用",
		"料理・子供と遊ぶ",
		"パソコンを使いこなせるようになると、世界が数倍に広がります！出来る自分をイメージして、一緒に楽しみながら学習しましょう！",
	)
);
?>
