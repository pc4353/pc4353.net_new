...
<link rel="canonical" href="http://www.pc4353.net/<?=$room[$id][dir]?>/">
<link rel="stylesheet" href="/st/css/smart.css">
...
<section id="schoolRoom" class="schoolRoom">
<div class="container">
<div class="btGoCountact"><a href="/<?=$room[$id][dir]?>/smart_contact.php">お問い合わせ・無料体験のお申込み</a></div>
...
<div class="sliderPhoto"><img src="/sp/images/bg_skill_check.jpg" alt="無料スキル診断は各教室で実施しています。お申し込みはメールまたはお電話で。所要時間は30分程度です。"></div>
...
//通常
?>
<div class="sliderPhoto"><a href="http://www.pc4353.net/15th/" target="_blank"><img src="/img/bnr-main05.png" alt="おかげさまで、パソコン市民講座15周年"></a></div>
<?php
}
?>
</section>
