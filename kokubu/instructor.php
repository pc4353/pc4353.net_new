...
$ary = array(
	...
	array(
		...
		"Word・Excel",
		"ネットショッピング・切り絵",
		"仕事で何となく必要だから何となくパソコンを使う…私もそんな一人でした。しかし、実際に使っているうちに「こんな事ができたらいいな。」という気持ちが大きくなり、基礎からしっかり学ぶ必要性と大切さを感じました。学ぶにつれて「こんな事ができるんだ！」とパソコンを使うことがとても楽しくなり、さらに資格を取る事で自分への自信に繋がります。<br />パソコンに少しでも不安を感じていらっしゃる方はぜひ教室を見に来てください。<br />「できたらいいな」から「できた！」へ私たちが一生懸命サポートさせていただきます。一緒に頑張りましょう♪"
	)
 );
?>
