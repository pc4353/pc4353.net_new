...
$ary = array(
	...
	array(
		...
		"ワード",
		"旅行・手芸・カリグラフィ",
		"Wordはビジネス文書のイメージが強いですが、使い方によっては自分の生活を楽しく彩ることができるツールです。私は、子どもたちの写真を使ってアルバムを作ったり、旅のしおりを作ったり、子どもたちが小さいときなどは、塗り絵やクラフトの型紙を作ったり、個人で楽しんできました。そんな、作品が一つずつ出来上がる楽しさを皆さんにお伝えしていきたいです。<br />声をかけやすい親しみやすいインストラクターを目指して、皆さんと一緒に成長していけたらと思っています！"
	)
);
?>
