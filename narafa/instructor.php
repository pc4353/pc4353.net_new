...
$ary = array(
	...
	array(
		...
		"ワード・iPad",
		"音楽・語学・アロマ",
		"私が最初にパソコンを触ったのは、子供の学校の役員になった時でした。必要に迫られて見よう見まねでしたが、習いに行って資格をとるうちにすっかりはまってしまいました。今ではパソコンだけでなく、iPhone、iPadも日々の生活にはなくてならない存在です。ワードで自治会の議事録作成、インターネットで飛行機のチケットやホテルの予約、外出にはiPhoneで無料の電話や写真を撮ったり、iPadは海外旅行の必需品です。使いこなすことによって生活が便利に、世界もどんどん広がりますよ！<br />皆さんのやる気を大切に、楽しく使えるようにサポートしていきます。"
	)
);
?>
