...
<meta name="description" content="My First PC プレゼントキャンペーン「はじめてのプログラミング講座」にご応募いただいた方がご使用いただけるコンテンツです。初心者からスキルアップ・資格取得まで安心のパソコン教室 パソコン市民講座(東京/大阪ほか全国)。" />
...
<div id='container_1534486214' ></div>
...
<script>
  ...
  OO.ready(function() {window.pp = OO.Player.create('container_1534486214', 'Zqc2QwZzE68J9a5MiOP7H8dFwYo-zpI3', playerParam);});
</script>
</body>
</html>