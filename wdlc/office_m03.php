...
<head>
<meta charset="utf-8" />
<title>「はじめてのOffice 講座」第3回　PowerPoint　表彰式ムービーを作ろう</title>
<meta name="viewport" content="width=device-width" />
<meta name="description" content="My First PC プレゼントキャンペーン「はじめてのOffice 講座」にご応募いただいた方がご使用いただけるコンテンツです。初心者からスキルアップ・資格取得まで安心のパソコン教室 パソコン市民講座(東京/大阪ほか全国)。" />
<meta name="keywords" content="WDLC,パソコン教室,パソコンスクール,資格,検定,東京,大阪,パソコン,市民講座,pc4353,PC教室,初心者,サーティファイ,MOS" />
<!-- GoogleAnalytics -->
<script>
...
<script src="//player.ooyala.com/core/9f9f7963d3649f0a3313005ac924cdc"></script>
<!-- The following div will contain the instantiated player, and is identified by id -->
<div id='container_1534481969' ></div>
...
<script>
  ...
  OO.ready(function() {window.pp = OO.Player.create('container_1534481969', 'l4bWQwZzE6UiCKtu69CqFoBLhWWFrlzv', playerParam);});
</script>
</body>
</html>