...
$ary = array(
	array(
		...
		"インターネット",
		"犬の美容・カラオケ・アロマストーン作り",
		"今ではPCやスマートフォンは1人1台の時代。生活にはかかせない物になってきました。私はインターネットで買い物をよくします。生活用品や趣味のアロマストーンやジェルネイルの材料を購入します。ネットを使い色んなところから情報を集め、買い物をするのは楽しいです。是非みなさんにもPCの楽しさを知ってもらえたら嬉しいです。元気があれば何でもできる！あなたの知らないPCの世界を、私たちと一緒に楽しく勉強しましょう♪"
	),
	array(
		"伊藤 先生",
		"ワード",
		"ドライブ・カラオケ・ライブに行くこと",
		"パソコンは難しい・・・と敬遠していませんか？インターネット、ワードでの作品作り、写真加工等、一人でも多くの方にパソコンの楽しさを知って頂きたいと思っています。初心者の方、趣味でパソコンを楽しみたい方、資格取得を目指す方、笹丘教室では学生さんから80代の方まで幅広い年代の方が通われています。どんな方でも安心して教室にお越しくださいね♪何でもお気軽にインストラクターに聞いてください(^^ゞ"
	)
);
?>
