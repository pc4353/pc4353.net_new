				...
				<div id="search-course" class="block">
					...
					<div class="section-lv2 clearfix mB30">
						...
						<div class="box-c clearfix">
							...
							<div class="mB30 align-c"><a href="/<?=$room[$id][dir]?>/contact.php"><img src="/images/btn-inq_contact.jpg" width="500" height="70" alt="無料説明会のお申込みはこちら" class="alpha" /></a></div>
					</div><!-- /.section-lv2 -->
					...
					<div class="section-lv2 mB20">
						<div class="moz4">
							...
							<dl class="clearfix moz4">
								...
								<dd class="box-b"><a href="/<?=$room[$id][dir]?>/about.php#point5">全国120教室、54万人以上の「豊富な指導実績」</a></dd>
							</dl>
						</div>
				...
				<div id="voice" class="block mB30">
					<h2><img src="/images/title_48.png" width="650" height="48" alt="受講生の声" /></h2>
					<div class="section-lv2">
						<ul class="clearfix mB10">
							<li class="li-top"><a href="/<?=$room[$id][dir]?>/voice.php#voice1"><img class="alpha" src="/<?=$room[$id][dir]?>/images/pic_116.jpg" alt="受講生の声" /></a></li>
							<li><a href="/<?=$room[$id][dir]?>/voice.php#voice2"><img class="alpha" src="/<?=$room[$id][dir]?>/images/pic_118.jpg" alt="受講生の声" /></a></li>
							<li><a href="/<?=$room[$id][dir]?>/voice.php#voice3"><img class="alpha" src="/<?=$room[$id][dir]?>/images/pic_120.jpg" alt="受講生の声" /></a></li>
							<li><a href="/<?=$room[$id][dir]?>/voice.php#voice4"><img class="alpha" src="/<?=$room[$id][dir]?>/images/pic_122.jpg" alt="受講生の声" /></a></li>
						</ul>
						<p class="align-r mR10"><a class="font12" href="/<?=$room[$id][dir]?>/voice.php">受講生の声をもっと見る</a></p>
					</div><!-- /.section-lv2 -->
				</div><!-- /#.block -->
