...
<title>サーティファイ ビジネス実践講座｜豊橋 豊川 田原 東三河のパソコン教室｜パソコン市民講座 バロー豊橋教室</title>
<meta name="keywords" content="パソコン教室,豊橋,豊川,田原,東三河,バロー豊橋教室,パソコンスクール,資格,検定,MOS,サーティファイ,ビジネスオンライン,PC教室,初心者">
<meta name="description" content="サーティファイ ビジネス実践講座｜初心者からスキルアップ・資格取得まで安心のパソコン教室。豊橋 豊川 田原 東三河のパソコン市民講座 バロー豊橋教室。MOS資格・サーティファイ技能検定などエクセル・ワード・パワーポイントの資格取得やビジネススキルアップを教室インストラクターがしっかりとサポート！">

<link rel="stylesheet" type="text/css" href="/css/style.css?1567060133" media="screen and (min-width: 768px), print" />
<link rel="stylesheet" type="text/css" href="/css/style-sp.css?1567060630" media="only screen and (max-width: 767px)" />
<link rel="stylesheet" type="text/css" href="/css/index_new.css?1566977097" media="screen and (min-width: 768px), print" />
<link rel="stylesheet" type="text/css" href="/css/index_new-sp.css?1566977102" media="only screen and (max-width: 767px)" />
<link rel="stylesheet" type="text/css" href="/common/css/certify_.css?1512982183" media="screen and (min-width: 768px), print" />
<link rel="stylesheet" type="text/css" href="/common/css/certify-sp_.css?1513057383" media="only screen and (max-width: 767px)" />
...
$(document).ready(function(){
	$('.slider').bxSlider({
      ...
      switch (slideIndex){
        ...
        case 3:
          return '<img src="/images/img-sokudoku_thumb.jpg" width="150" />';
...
<div id="hd_lft">
<p class="hd_txt">豊橋 豊川 田原 東三河で資格が取れるパソコン教室　<br class="sp-only" />パソコン市民講座 バロー豊橋教室</p>
	<div id="hd_logo"><a href="/toyohashi/">
		<img class="pc-only" src="/images/img-hd_logo.png" width="211" height="34" alt="豊橋 豊川 田原 東三河の資格が取れるパソコン教室｜パソコン市民講座 バロー豊橋教室">
		<img class="sp-only" src="/common/img/common/logo1.png" width="156" height="68" alt="豊橋 豊川 田原 東三河の資格が取れるパソコン教室｜パソコン市民講座 バロー豊橋教室">
	</a></div>
<div id="hd_room">バロー豊橋教室</div>
</div>
<div id="hd_rgt">
<ul class="link">
<li><a href="/toyohashi/qa.php">よくある質問</a></li>
</ul>
<div id="hd_tel">0532-43-6470</div>
	<div id="hd_reception">受付時間/<br>
	<a href="/toyohashi/about.php">営業時間はこちら</a>
	</div>
	<div class="header-btn1 sp-only"><a href="/toyohashi/contact.php"><img src="../images/btn-inq_taiken.png" width="127" height="33" alt="無料体験予約"></a></div>
...
<li><a href="/toyohashi/about.php">教室情報</a></li>
<li><a href="/toyohashi/course.php">講座紹介</a></li>
<li><a href="/toyohashi/voice.php">受講生の声</a></li>
<li class="last"><a href="/toyohashi/apply.php">お申込み方法</a></li>
</ul>
<ul class="inq_btn clearfix">
<li class="fl_left"><a href="/toyohashi/contact.php"><img src="../images/btn-inq_taiken.png" width="127" height="33" alt="無料体験予約"></a></li>
<li class="fl_right"><a href="/toyohashi/doc_contact.php"><img src="../images/btn-inq_shiryo.png" width="102" height="33" alt="資料請求"></a></li>
</ul>
</div>
</nav>
</header>
				  ...
				  <dl class="locus">
					...
					<dd>
					  <ul>
						...
						<li><a href="/school/aichi.php">愛知県のパソコン教室を探す</a> ＞</li>
						<li><a href="/toyohashi/">豊橋 豊川 田原 東三河のパソコン教室・講座TOP</a> ＞</li>
...
<div class="p-cert">
    ...
    <div class="p-cert1 c-wrap">
        <h2><img src="/certify/images/img-01.png" alt="【ビジネス実践講座】パソコンを「使える人」ではなく「使いこなせる人」へ" /></h2>
        <div class="p-cert1__block1">
			<h3 class="cert_tit2"><span>使いこなせればこんなにメリット！</span></h3>
            <p><img src="/certify/images/illust-01.png" alt="ビジネスの現場で書類作成の時間を半分に！　→　同じ時間でも書類の内容を吟味できる！　→　同僚に差がすく！就職先でも大活躍！" /></p>
        </div><!-- /.p-cert1__block1 -->
    </div><!-- /.p-cert1 -->
    ...
    <div class="p-cert2">
        ...
        <div class="c-wrap2">
        <div class="p-cert1__block1 clearfix">			
			<ul id="menu_list">
    		<li class="box1 word word_sima"><a href="#word"><span>Word</span>(ビジネス文書)</a></li>
    		<li class="box1 excl excl_sima"><a href="#excl"><span>Excel</span>(表計算)</a></li>
    		<li class="box1 powp powp_sima"><a href="#powp"><span>PowerPoint</span>(プレゼン)</a></li>
			</ul>
		</div>
		</div>
...
<!-- /.word -->
		...
		<div class="contents_tit">	
			<dl class="word">
				<dt><h3>Word<span>(ワード)</span>講座</h3></dt>
			<dd>チラシ／ビジネス文書／はがき／連絡網／回覧板／年賀状</dd>
			</dl>	
		</div><!-- /.contents_tit -->
		</div><!-- /.c-wrap2 -->
		</div><!-- /.word_sima -->	
		...
		<div class="contents_item">		
			<h4 class="cert_tit3">こんなあなたに</h4>
			<div class="icon_woman"><img src="/certify/images/illust-02.png"></div>
				<div class="trouble_a">
				<ul>
					<li>いつも手書きでチラシを作っている</li>
				...
				<div class="trouble_b">
				<div class="trouble_img"><img src="/certify/images/img-03.png"></div>
				</div>
		</div><!-- /.contents_item -->
...
<!-- /.osusume -->
		<div class="contents_item">	
			<div class="icon_woman"><img src="/certify/images/illust-03.png"></div>	
			<h4 class="cert_tit4">あなたにオススメの講座はコレ！</h4>

		<div class="table_wordtit">	
			<h4 class="cert_tit5">効率の良いビジネス書類で同僚に差をつけるなら！</h4>
		</div>
		<div class="table_word">	
			<table>
				<tr><th colspan="2"><div class="word_sima clearfix"><span class="cube_word">Word2013対応</span><span class="t_title">ビジネスワード実践講座　基礎編・応用編</span></div></th></tr>
				<tr><td colspan="2" class="gr">サーティファイが主催する「Word 文書処理技能認定試験」の合格を目指すための講座です。ビジネス実践講座よりも、より試験対策に特化した内容で、試験合格に必要なスキルが習得できます。ビジネスシーンでの実践力を身に付けながら、サーティファイの資格取得を目指しましょう！ </td></tr>
				<tr><td class="wi t-width">主な講座内容</td>
					<td class="wi">基本編：ページの書式設定、ヘッダーとフッター、印刷、タブとリーダー、画像の挿入など<br>応用編：段組み、文書の校正、SmartArt、Excelデータの貼り付け、差し込み印刷など</td></tr>
				<tr><td class="gr t-width">受講回数</td>
					<td class="gr">基本編（3級対応）20回　　応用編（2級対応）20回</td></tr>
				<tr><td class="wi t-width">目安の受講期間</td>
					<td class="wi">各　約1ヶ月</td></tr>
			</table>
		</div>	

		<div class="table_wordtit">
		  <h4 class="cert_tit5">最新の資格を取得してスキルアップするなら！</h4>
		</div>
		<div class="table_word">	
			<table>
				<tr><th colspan="2"><div class="word_sima clearfix"><span class="cube_word">Word2016対応</span><span class="t_title">サーティファイ資格対策講座 Word3級・2級</span></div></th></tr>
				<tr><td colspan="2" class="gr">サーティファイが主催する「Word 文書処理技能認定試験」の合格を目指すための講座です。ビジネス実践講座よりも、より試験対策に特化した内容で、試験合格に必要なスキルが習得できます。ビジネスシーンでの実践力を身に付けながら、サーティファイの資格取得を目指しましょう！</td></tr>
				<tr><td class="wi t-width">主な講座内容</td>
					<td class="wi">3級・2級ともに、サーティファイ資格検定試験のテキストを使い、練習問題やテーマ別知識問題、模擬問題を解いていきます。</td></tr>
				<tr><td class="gr t-width">受講回数</td>
					<td class="gr">（3級）18回　　（2級）20回</td></tr>
				<tr><td class="wi t-width">目安の受講期間</td>
					<td class="wi">各　約3週間～1ヶ月</td></tr>
			</table>
		</div>	
		</div><!-- /.contents_item -->
		</div><!-- /.c-wrap2 -->
...
<!-- /.excel -->
		...
		<div class="contents_tit">	
			<dl class="excl">
				<dt><h3>Excel<span>(エクセル)</span>講座</h3></dt>
			<dd>集計表／住所録／自動計算／マクロ／データ分析／グラフ作成</dd>
			</dl>	
		</div><!-- /.contents_tit -->
		</div><!-- /.c-wrap2 -->
		</div><!-- /.excl_sima -->	
		...
		<div class="contents_item">		
			...
			<div class="icon_woman"><img src="/certify/images/illust-02.png"></div>
				...
				<div class="trouble_b">
				<div class="trouble_img"><img src="/certify/images/img-05.png"></div>
				</div>
		</div><!-- /.contents_item -->
...
<!-- /.osusume -->
		...
		<div class="table_excltit">	
			<h4 class="cert_tit5">関数やマクロを使って作業効率大幅アップ！</h4>
		</div>
		<div class="table_excl">	
			<table>
				<tr><th colspan="2"><div class="excl_sima clearfix"><span class="cube_excl">Excel2013対応</span><span class="t_title">ビジネスエクセル実践講座　基礎編・応用編</span></div></th></tr>
				<tr><td colspan="2" class="gr">ビジネスの現場が求めるスキルを習得できる講座です。「エクセルは使ったことがあるけれど不安…」「効率的に作業をしたい！」という方に最適です。講座では、「実務性」の高さを大切にしているサーティファイの資格検定試験のテキストを使うため、受講後はあなたのスキルを証明する資格取得にもチャレンジすることができます。</td></tr>
				<tr><td class="wi t-width">主な講座内容</td>
					<td class="wi">基本編：数式の入力、表の編集、グラフの作成、統計関数など<br>応用編：入力規則、条件付き書式、データの保護、関数、データベース、ピボットテーブル、マクロなど</td></tr>
				<tr><td class="gr t-width">受講回数</td>
					<td class="gr">基本編（3級対応）：20回　　応用編（2級対応）20回</td></tr>
				<tr><td class="wi t-width">目安の受講期間</td>
					<td class="wi">各　約1ヶ月</td></tr>
		...
		<div class="table_excl">	
			<table>
				<tr><th colspan="2"><div class="excl_sima clearfix"><span class="cube_excl">Excel2016対応</span><span class="t_title">サーティファイ資格対策講座　Excel3級・2級</span></div></th></tr>
				<tr><td colspan="2" class="gr">サーティファイが主催する「Excel 表計算処理技能認定試験」の合格を目指すための講座です。ビジネス実践講座よりも、より試験対策に特化した内容で、試験合格に必要なスキルが習得できます。ビジネスシーンでの実践力を身に付けながら、サーティファイの資格取得を目指しましょう！</td></tr>
				<tr><td class="wi t-width">主な講座内容</td>
					<td class="wi">3級・2級ともに、サーティファイ資格検定試験のテキストを使い、練習問題やテーマ別知識問題、模擬問題を解いていきます。</td></tr>
				<tr><td class="gr t-width">受講回数</td>
					<td class="gr">（3級）17回　　（2級）20回</td></tr>
				<tr><td class="wi t-width">目安の受講期間</td>
					<td class="wi">各　約3週間～1ヶ月</td></tr>
			</table>
		</div>	
...
<!-- /.powp -->
		...
		<div class="contents_tit">	
			<dl class="powp">
				<dt><h3>PowerPoint<span>(パワーポイント)</span>講座</h3></dt>
			<dd>企画書／提案書／プレゼン資料／スライドショー</dd>
			</dl>	
		</div><!-- /.contents_tit -->
		</div><!-- /.c-wrap2 -->
		</div><!-- /.powp_sima -->	
		...
		<div class="contents_item">		
			...
			<div class="icon_woman"><img src="/certify/images/illust-02.png"></div>
				...
				<div class="trouble_b">
				<div class="trouble_img"><img src="/certify/images/img-07.png"></div>
				</div>
		</div><!-- /.contents_item -->
...
<!-- /.osusume -->
		<div class="contents_item">	
			<div class="icon_woman"><img src="/certify/images/illust-03.png"></div>	
			<h4 class="cert_tit4">分かりやすいプレゼン資料で受注率アップ！</h4>

		<div class="table_powptit">	
			<h4 class="cert_tit5">効率の良いビジネス書類で同僚に差をつけるなら！</h4>
		</div>
		<div class="table_powp">	
			<table>
				<tr><th colspan="2"><div class="powp_sima clearfix"><span class="cube_powp">PowerPoint2013対応</span><span class="t_title">ビジネスパワーポイント実践講座</span></div></th></tr>
				<tr><td colspan="2" class="gr">ビジネスの現場が求めるスキルを習得できる講座です。「パワーポイントは使ったことがあるけれど不安…」「効率的に作業をしたい！」という方に最適です。講座では、「実務性」の高さを大切にしているサーティファイの資格検定試験のテキストを使うため、受講後は資格取得にもチャレンジすることができます。</td></tr>
				<tr><td class="wi t-width">主な講座内容</td>
					<td class="wi">プレゼンテーションの作成、オブジェクトの作成、<br>スライドショーの実行、効果的なプレゼン資料の作り方など</td></tr>
				<tr><td class="gr t-width">受講回数</td>
					<td class="gr">（初級・上級対応）16回</td></tr>
				<tr><td class="wi t-width">目安の受講期間</td>
					<td class="wi">約1ヶ月</td></tr>
			</table>
		</div>	
		...
		<div class="table_powp">	
			<table>
				<tr><th colspan="2"><div class="powp_sima clearfix"><span class="cube_powp">PowerPoint2016対応</span><span class="t_title">サーティファイ資格対策講座　PowerPoint初級・上級</span></div></th></tr>
				<tr><td colspan="2" class="gr">サーティファイが主催する「PowerPoint プレゼンテーション技能認定試験」の合格を目指すための講座です。ビジネス実践講座よりも、より試験対策に特化した内容で、試験合格に必要なスキルが習得できます。ビジネスシーンでの実践力を身に付けながら、サーティファイの資格取得を目指しましょう！</td></tr>
				<tr><td class="wi t-width">主な講座内容</td>
					<td class="wi">初級・上級ともに、サーティファイ資格検定試験のテキストを使い、<br>練習問題やテーマ別知識問題、模擬問題を解いていきます。</td></tr>
				<tr><td class="gr t-width">受講回数</td>
					<td class="gr">（初級）10回　　（上級）18回</td></tr>
				<tr><td class="wi t-width">目安の受講期間</td>
					<td class="wi">（初級）約2週間　（上級）約3週間～1ヶ月</td></tr>
			</table>
		</div>	
		</div><!-- /.contents_item -->
		</div><!-- /.c-wrap2 -->
...
<dt>コース一覧</dt>
<dd><a href="/toyohashi/course.php">講座案内</a></dd>
<dd><a href="/toyohashi/certify.php">ビジネス実践講座</a></dd>
<dd><a href="/toyohashi/mos.php">MOS資格対策講座</a></dd>
<dd><a href="/toyohashi/win10.php">Windows10講座</a></dd>
<dd><a href="/toyohashi/course.php#subject3">パソコン趣味講座</a></dd>
<dd><a href="/toyohashi/tablet.php">iPad講座</a></dd>
<dd><a href="/toyohashi/iphone.php">iPhone講座</a></dd>
</dl>
<dl class="ft_about clearfix">
<dt>教室概要</dt>
<dd><a href="/toyohashi/about.php">教室紹介</a></dd>
<dd><a href="/toyohashi/instructor.php">インストラクター紹介</a></dd>
<dd><a href="/toyohashi/voice.php">受講生の声</a></dd>
<!--<dd><a href="/toyohashi/contact.php">ワンポイント動画</a></dd>-->
<dd><a href="/premiere.php">プレミア倶楽部</a></dd>
<dd><a href="/toyohashi/qa.php">よくあるご質問</a></dd>
<dd><a href="/toyohashi/apply.php">お申込み方法</a></dd>
<!--<dd><a href="/toyohashi/contact.php">キャンペーン</a></dd>-->
</dl>
...
<dd><a href="/school/niigata.php">新潟</a></dd>
...
<dl class="ft_near_list clearfix"><dt>近くの教室からパソコン教室を探す</dt><dd><a href="/entetsu/">遠鉄百貨店（JR浜松駅）教室</a></dd></dl></div>
<div id="ft_rgt" class="tk-kozuka-gothic-pr6n">
	<div id="ft_logo"><a href="/toyohashi/"><img src="../images/img-ft_logo.png" width="168" height="85" alt="豊橋 豊川 田原 東三河の資格が取れるパソコン教室｜パソコン市民講座 バロー豊橋教室"></a></div>
<div id="ft_room">バロー豊橋教室</div>
<ul class="inq_btn clearfix">
<li class="fl_left"><a href="/toyohashi/contact.php">
...
<li class="fl_right"><a href="/toyohashi/doc_contact.php">
...
<div id="ft_tel_box">
<div id="ft_tel">0532-43-6470</div>
...
<!--<li><a href="/toyohashi/sitemap.php">サイトマップ</a></li>-->
</ul>
<address>COPYRIGHT 2019 Cheery, All Rights Reserved.</address>
</div>
</div>
</footer>
