...
include_once("../lib_test/sokudoku_contact_options.php");
...
if( !$nichiji_1 || !$nichiji_2 || !$nichiji_3 ) {
	$errormsg .= "<label for=\"nichiji_1\">■無料体験希望日" . $msg2 . "</label><br />\n" ;
	$erNichiji = $erBg;
}
...
?>
                <div id="toiawase_form">
					<div class="i-pt clearfix mB20 mR10">
						...
						<form action="sokudoku_contact_complete.php" method="post">
						...
						<tr>
                            ...
                            <p class="red">※後程、お電話にてお時間の確認をさせていただきます。</p></td>
						</tr>
						<tr>
							<th>ご質問など</th>
