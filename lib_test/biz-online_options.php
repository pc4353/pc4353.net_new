...
/* このスクリプトのパス */
$script_path = "/" . $room[$id][dir] . "/biz-online.php";
...
?>
						...
						<div class="section-lv2 moz2 mB30 clearfix">
							...
							・営業時間は<a href="/<?=$room[$id][dir]?>/about.php#about4">こちらをご覧ください</a></p>
						</div><!-- /.section-lv2 -->
						</div>
<?php
}
...
<tr>
	...
	<td<?= $erName ?>><input type="text" value="<?= $name ?>" name="name" maxlength="20" size="40" class="form_input01"></td>
</tr>
<tr>
	<th>フリガナ　<span class="red">必須</span></th>
	<td<?= $erKana ?>><input type="text" value="<?= $kana ?>" name="kana" maxlength="20" size="40" class="form_input01"></td>
</tr>
<tr>
	<th>電話番号（携帯可）　<span class="red">必須</span></th>
	<td<?= $erPhone ?>><input type="text" value="<?= $phone ?>" name="phone" maxlength="15" size="30" class="form_input02"></td>
</tr>
<tr>
	<th>メールアドレス</th>
	<td><input type="text" value="<?= $mail ?>" name="mail" maxlength="100" size="40" class="form_input01"></td>
</tr>
<tr>
	<th>住所</th>
	<td><input type="text" value="<?= $address ?>" name="address" maxlength="100" size="40" class="form_input01"></td>
</tr>
<tr>
...
<!--<tr>
	...
	<td<?= $erCourse ?>><label><input type="radio" class="nBn" value="短期集中コース" name="course"<? if( $course == "短期集中コース" ) { echo " checked"; } ?>>短期集中コース</label>
						<label><input type="radio" class="nBn" value="標準コース" name="course"<? if( $course == "標準コース" ) { echo " checked"; } ?>>標準コース</label>
						<label><input type="radio" class="nBn" value="実力養成コース" name="course"<? if( $course == "実力養成コース" ) { echo " checked"; } ?>>実力養成コース</label></td>
</tr>-->
<tr>
	<th>ご質問など</th>
