            ...
            <div class="p-mos3__block1">
                ...
                <ul>
                    <li>
                        ...
                        <div class="txt1">
                            <p>自分のペースで<br />学べる</p>
                            <a class="mos_btn2" href="/<?=$room[$id][dir]?>/about.php#point1">詳しくはコチラ</a>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="txt1">
                            ...
                            <a class="mos_btn2" href="/<?=$room[$id][dir]?>/about.php#point4">詳しくはコチラ</a>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="txt1">
                            <p>月謝制だから<br />続けやすい</p>
                            <a class="mos_btn2" href="/<?=$room[$id][dir]?>/about.php#point3">詳しくはコチラ</a>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="txt1">
                            ...
                            <a class="mos_btn2" href="/<?=$room[$id][dir]?>/about.php#point2">詳しくはコチラ</a>
                        </div>
                    </li>
                    <li>
