...
<div id="main_contents" class="clearfix">
       <?php if (date("Ymd") <= 20200315) : ?> <!-- 表示するまでの期間をyyyymmddで記載　-->
<?php
if( $id == "6015000" ) {
	//test
?>
                    ...
                    <dt>【店舗移転のご案内】</dt>
                    <dd><p>「パソコン市民講座 イオン上飯田教室」は2019年12月23日（月）をもちまして閉校し、「パソコン市民講座 メッツ大曽根教室」として2020年1月6日（月）より移転リニューアルオープンいたしました。今後とも変わらぬご愛顧のほどよろしくお願い申し上げます。<br>【新住所】愛知県名古屋市東区矢田2丁目1-95　メッツ大曽根  3F　<a href="https://goo.gl/maps/nDCohce77RTYSAeJ7" target="_blank">地図を表示する</a></p>
					</dd>
                    </dl>
<?php
}elseif ($id !== "1076000" ) {
?>
                    <dl class="notice tk-kozuka-gothic-pr6n">
                    <dt>【2020年2月28日 更新】</dt>
                    <dd><p><a href="https://www.pc4353.net/news/20200228/" target="_blank">パソコン市民講座 全教室における「新型コロナウイルス感染症の対策」について</a></p>
					</dd>
                    </dl>
<?php
}
...
<div class="main_vi">
<ul class="slider">
       <?php if (date("Ymd") >= 20200322) : ?> <!-- 表示するまでの期間をyyyymmddで記載　-->
	<?php
	if ($id == "1076000" ) {
		//けやき
	?>
	...
	?>
     ...
     <?php if (date("Ymd") <= 20200321) : ?> <!-- 表示するまでの期間をyyyymmddで記載　-->
	<?php
	if ($id == "1076000" ) {
		//けやき
	?>
	...
	<?php
		...
		//速読
	?>
	<li><a href="/<?=$room[$id][dir]?>/contact.php"><img src="../images/img-main_cp2003-1.jpg" width="985" height="300" alt="はじめるなら3月が断然お得！「総額最大12,000円OFF」早割キャンペーン実施中！！" class="alpha" /></a></li>
	<li><a href="/<?=$room[$id][dir]?>/junior.php"><img src="../images/img-main04.jpg" width="985" height="300" alt="子どもパソコン講座開講！詳しくはこちらから" class="alpha" /></a></li>
	<li><a href="/<?=$room[$id][dir]?>/gakuwari.php"><img src="../images/img-main07.jpg" width="985" height="300" alt="小学生から大学生までお得に学べる学割制度" class="alpha" /></a></li>
	<li><a href="/<?=$room[$id][dir]?>/mos.php"><img src="../images/img-main02.jpg" width="985" height="300" alt="就職・転職を有利に！資格は実力の証！MOS資格取得コース" class="alpha" /></a></li>
	<li><a href="/<?=$room[$id][dir]?>/sokudoku.php"><img src="../images/img-main06.jpg" width="985" height="300" alt="みんなの速読 無料体験募集中！" class="alpha" /></a></li>
...
<section>
	...
	<div class="course_list">
		...
		<dl>
			...
			<dd><img src="/course/images/bnr-course01.jpg" alt="MOS資格対策講座"></dd>
		...
		<dl>
			...
			<dd><img src="/course/images/bnr-course02.jpg" alt="サーティファイ講座"></dd>
		...
		<dl>
			...
			<dd><img src="/course/images/bnr-course03.jpg" alt="仕事で役立てたい"></dd>
			<dd class="c"><p>仕事で役立てたい</p></dd>
			</dl>
			</a></li>
		<li><a href="/<?=$room[$id][dir]?>/course.php#lisence">
		<dl>
			<dt>仕事に活かせる！<br class="pc-only">さらにスキルアップ</dt>
			<dd><img src="/course/images/bnr-course04.jpg" alt="資格を取得したい"></dd>
		...
		<dl>
			...
			<dd><img src="/course/images/bnr-course05.jpg" alt="基本操作を覚えたい"></dd>
		...
		<dl>
			...
			<dd><img src="/course/images/bnr-course06.jpg" width="200" height="114" alt="タブレット・スマホ"></dd>
		...
		<dl>
			...
			<dd><img src="/course/images/bnr-course07.jpg" alt="ネットを楽しみたい"></dd>
			<dd class="g"><p>ネットを楽しみたい</p></dd>
			</dl>
			</a></li>
		<li><a href="/<?=$room[$id][dir]?>/course.php#hobby">
		<dl>
			<dt>パソコンで、趣味の世界が<br class="pc-only">どんどん広がる♪</dt>
			<dd><img src="/course/images/bnr-course08.jpg" alt="趣味で楽しみたい"></dd>
		...
		<dl>
			...
			<dd><img src="/course/images/bnr-course09.jpg" alt="小中学生のPC学習"></dd>
			<dd class="i"><p>小中学生のPC学習</p></dd>
			</dl>
			</a></li>
		<li><a href="/<?=$room[$id][dir]?>/rehire.php">
		<dl>
			<dt>シニア世代の再雇用に<br class="pc-only">パソコンスキル活用！</dt>
			<dd><img src="/course/images/bnr-course10.jpg" alt="再雇用・再就職"></dd>
			<dd class="i"><p>再雇用・再就職</p></dd>
			</dl>
			</a></li>
		<li class="bnr_l pc-only"><a href="http://www.star-programming-school.com/" target="_blank">
			<img src="../images/bnr-course_sps_l.png" width="462" uheight="194" alt="スタープログラミングスクール"></a></li>
		</ul>
		</div>
	</div>
...
<section>
	<div class="osusume_list">
		...
		<dl>
			...
			<dd><p><b>全国100教室 54万人以上の指導実績！</b><br>
...
?>
		...
		<div class="room_info_lft">
		<dl>
			<dt><a href="../images/2020typing.jpg" target="_blank"><img src="../images/2020typing.jpg" width="180" alt="小学生から始めて、将来に備えよう！『小中学生のパソコン学習』大好評受付中！"></a></dt>
		</dl>
		</div>
		<div class="room_info_rgt">
		<dl>
			<dt class="tk-kozuka-gothic-pr6n">タイピングスキルを習得しよう！！</dt>
			<dd><p>小学生から始めて、将来に備えよう！<strong>『小中学生のパソコン学習』大好評受付中！</strong></p>
			<p>パソコン市民講座 <?=$room[$id][name]?>教室では、<a href="junior.php">『小中学生のパソコン学習』</a>をサポート！2020年からのプログラミング必修化や、学生のパソコンスキルが必須になってくるであろうこれからの教育に必要となる<strong>「タイピング」スキルの習得をサポート</strong>していきます！！</p>
...
//SPS個別実施校
?>
			<dt><a href="../images/202003cp2.jpg" target="_blank"><img src="../images/202003cp2.jpg" width="180" alt="早割キャンペーン実施中！！"></a>
<?php
}elseif( $room[$id][spp] == "0" ) {
//SPS個別未実施校
?>
			<dt><a href="../images/202003cp1.jpg" target="_blank"><img src="../images/202003cp1.jpg" width="180" alt="早割キャンペーン実施中！！"></a>
<?php
}
?>
				</dt>
		...
		<div class="room_info_rgt">
		<dl>
			<dt class="tk-kozuka-gothic-pr6n">総額最大12,000円お得！早割キャンペーン！！</dt>
			<dd><p>「やってみたい」が「できた！」に変わる！幅広い年齢層の方々が楽しく学ばれています。</p>
			<p>パソコン市民講座 <?=$room[$id][name]?>教室（<?=$room[$id][area]?>）では、<strong>期間限定「総額最大12,000円OFF」早割キャンペーン！！</strong>を<strong>3月21日（土）まで実施中</strong>です！この機会にぜひお申込みください！</p>
...
<?php
	if ($room[$id][other_area] == "1") {
		echo "<li><dl><dt class=\"tk-kozuka-gothic-pr6n\"><span>近くの教室を探す</span></dt>";
