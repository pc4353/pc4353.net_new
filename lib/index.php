...
<section>
	<div class="room_info">
		...
		<div class="room_info_lft">
		<dl>
			<dt><a href="../images/201708cp1.jpg" target="_blank"><img src="../images/201708cp1.jpg" width="180" alt="9月から始めるより今からが断然お得な「早得」キャンペーン！"></a></dt>
			<dd><div class="inst_info"><a href="/<?=$room[$id][dir]?>/instructor.php">インストラクター情報</a></div></dd>
		</dl>
		</div>
		<div class="room_info_rgt">
		<dl>
			<dt class="tk-kozuka-gothic-pr6n">9月から始めるより断然お得な「早得」キャンペーン！</dt>
			<dd><p>「やってみたい」が「できた！」に変わる！幅広い年齢層の方々が楽しく学ばれています。</p>
			<p>パソコン市民講座で学ばれる皆さんは、人それぞれに様々な目標を持って学んでいらっしゃいます。<br>きっかけは「やってみたい！」という気持ちから、まずは無料体験にお申し込みすることです！あなたの「やってみたい」を「できた！」に変えましょう！<?=$room[$id][name]?>教室のインストラクターがあなたに合わせたカリキュラムをご提案させていただきます。<br>パソコン市民講座では、8月31日（木）まで「早得キャンペーン」を実施中です！</p>
			<p>今なら<strong>総額最大で12,000円（税別）もお得</strong>になる、「早割キャンペーン」を実施！！</p>
			<p>これから迎える9月は求人数が増える時期です。就職・転職までの2か月の間にパソコンの資格を取得し、オフィスで活躍するパソコンスキルを身に付けておけば、転職・就職活動で有利に！<br>ビジネス実践講座や資格対策講座も、<?=$room[$id][name]?>教室のインストラクターが安心のサポート体制であなたをバックアップいたします！</p>
