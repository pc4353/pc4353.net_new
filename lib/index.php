...
<section>
	<div class="room_info">
		...
		<dl>
			<dt><img src="../images/shinibaraki_ent.jpg" width="180" alt="教室外観"><a href="../images/201709cp1.jpg" target="_blank"><img src="../images/201709cp1.jpg" width="180" alt="最大6,000円OFFキャンペーン！"></a></dt>
			<dd><div class="inst_info"><a href="/<?=$room[$id][dir]?>/instructor.php">インストラクター情報</a></div></dd>
		</dl>
		</div>
		<div class="room_info_rgt">
		<dl>
			<dt class="tk-kozuka-gothic-pr6n">【2017年9月1日 新規開校のご案内】</dt>
			<dd><p>「パソコン市民講座 イオンスタイル新茨木教室」9月1日オープン！！</p>
			<p>イオンスタイル新茨木店の3階に「パソコン市民講座　イオンスタイル新茨木教室」が2017年9月1日に新規開校いたしました。</p>
...
<section>
	<div class="room_info">
		...
		<div class="room_info_lft">
		<dl>
			<dt><a href="../images/201709cp1.jpg" target="_blank"><img src="../images/201709cp1.jpg" width="180" alt="最大6,000円OFFキャンペーン！"></a><a href="../images/201709cp2.jpg" target="_blank"><img src="../images/201709cp2.jpg" width="180" alt="最大6,000円OFFキャンペーン！"></a></dt>
			<dd><div class="inst_info"><a href="/<?=$room[$id][dir]?>/instructor.php">インストラクター情報</a></div></dd>
		</dl>
		</div>
		<div class="room_info_rgt">
		<dl>
			<dt class="tk-kozuka-gothic-pr6n">最大6,000円OFFキャンペーン！</dt>
			<dd><p>「やってみたい」が「できた！」に変わる！幅広い年齢層の方々が楽しく学ばれています。</p>
			<p>パソコン市民講座で学ばれる皆さんは、人それぞれに様々な目標を持って学んでいらっしゃいます。<br>きっかけは「やってみたい！」という気持ちから、まずは無料体験にお申し込みすることです！あなたの「やってみたい」を「できた！」に変えましょう！<?=$room[$id][name]?>教室のインストラクターがあなたに合わせたカリキュラムをご提案させていただきます。<br>パソコン市民講座では、9月22日（金）まで「最大6,000円OFFキャンペーン」を実施中です！</p>
			<p>さらに<strong>体験当日ご入会の方には、入会金半額！</strong></p>
			<p>これから迎える9月は求人数が増える時期です。就職・転職までの間にパソコンの資格を取得し、オフィスで活躍するパソコンスキルを身に付けておけば、転職・就職活動で有利に！<br>ビジネス実践講座や資格対策講座も、<?=$room[$id][name]?>教室のインストラクターが安心のサポート体制であなたをバックアップいたします！</p>
