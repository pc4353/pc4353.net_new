...
/* このスクリプトのパス */
$script_path = "/" . $room[$id][dir] . "/sokudoku.php";
...
global $name, $kana, $phone, $mail, $old, $student, $purpose, $other, $nichiji, $nichiji_1, $nichiji_2, $nichiji_3, $course, $question;
?>
...
<tr>
	...
	<td><ul>
<?php
$purpose[0] = "読書スピードを上げたい";
$purpose[1] = "読解力を高めたい";
$purpose[2] = "集中力を高めたい";
$purpose[3] = "資料やメールを早く処理したい";
$purpose[4] = "学校の成績アップにつなげたい";
$purpose[5] = "資格試験の勉強の効率を上げたい";
$purpose[6] = "記憶力を高めたい";
$purpose[7] = "脳トレをしながら認知症を防止したい";
$purpose[8] = "動体視力を鍛えてスポーツに役立てたい";
$purpose[9] = "その他";
