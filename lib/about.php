...
パソコン市民講座　<?=$room[$id][name]?>教室のホームページへようこそ☆<br /><br />
      <?php if (date("Ymd") <= 20180513) : ?> <!-- 表示するまでの期間をyyyymmddで記載　-->
◆ゴールデンウィーク企画「合格保証キャンペーン」を実施しております。◆<br /><br />
4月より新しい環境で、お仕事や学校に通われている方からパソコン操作の必要性を実感している事をよくお話し頂きます。やはり、今は職場でも学校でもパソコンを避けて通る訳にはいかなくなっているようです。<br />
パソコン市民講座では、みなさんのスキルアップをお手伝いしようと資格試験を「合格保証」という形でサポートさせて頂くキャンペーンを実施しております。<br />
是非、この機会に資格を取得してみませんか？必ず、お役に立つスキルと自信につながるものになると思います。<br />
ご興味のある方は、是非<?=$room[$id][name]?>教室にお問い合わせください。<br /><br />
      <?php endif; ?>

      <?php if (date("Ymd") >= 20180514) : ?> <!-- 表示するまでの期間をyyyymmddで記載　-->
...
ご興味のある方は、是非<?=$room[$id][name]?>教室にご一報ください。<br /><br />
      ...
      <?php if (date("Ymd") >= 20180521) : ?> <!-- 表示するまでの期間をyyyymmddで記載　-->
...
ご興味のある方は、是非<?=$room[$id][name]?>教室にご一報ください。<br /><br />
      ...
      <?php if (date("Ymd") <= 20180401) : ?> <!-- 表示するまでの期間をyyyymmddで記載　-->
