...
<?php
if ($id == "6015097" || $id == "6015002" || $id == "6015121" || $id == "6015104" || $id == "6015124" || $id == "6015083" || $id == "6015090" || $id == "6015076" || $id == "6015030") {
?>
...
パソコン市民講座　<?=$room[$id][name]?>教室のホームページへようこそ☆<br /><br />
      <?php if (date("Ymd") <= 20180211) : ?> <!-- 表示するまでの期間をyyyymmddで記載　-->
...
一つの操作でも沢山のやり方があります。簡単な事で効率よくエクセルが使える事を体験で実感して下さいね。<br /><br />
      ...
      <?php if (date("Ymd") >= 20180212) : ?> <!-- 表示するまでの期間をyyyymmddで記載　-->
...
<?=$room[$id][name]?>教室のインストラクターが、全力であなたの「出来る」を応援します！<br /><br />
      ...
      <?php if (date("Ymd") >= 20180219) : ?> <!-- 表示するまでの期間をyyyymmddで記載　-->
◆スキルチェックを実施中！◆<br /><br />
...
パソコンを使いこなそうとお考えの方は是非一度、<?=$room[$id][name]?>教室の方までご連絡してみて下さい！<br /><br />
      ...
      <?php if (date("Ymd") <= 20180205) : ?> <!-- 表示するまでの期間をyyyymmddで記載　-->
...
◆今年こそ、パソコンスキルを身に付けよう！◆<br /><br />
新しい年が始まり、今年の目標などは立てられましたか？<br />
昨年出来なかった作表をスムーズに作る、文書作成に時間が掛かるので効率よく作成する、データの集約や分析を効率よく熟す・・・など、パソコンに関わる内容でしたら、スキルアップが近道です。<br />
...
今年こそ、あいまいなスキルをしっかりと身に付けたい！と思われている方、もっとパソコンを使えるようになりたい方、是非<?=$room[$id][name]?>教室にお問い合わせください。<br /><br />
      <?php endif; ?>
