...
<div id="main_contents" class="clearfix">
       <?php if (date("Ymd") >= 20181026) : ?> <!-- 表示するまでの期間をyyyymmddで記載　-->
<?php
if( $id == "6015000" ) {
	//test
?>
...
?>
                    <dl class="notice tk-kozuka-gothic-pr6n">
                    <dt>【店内移転のご案内】</dt>
                    <dd><p>パソコン市民講座 イトーヨーカドーあべの教室は店内フロア移転のため、10月27日（土）より２階から１階へ教室が移動になります。ご来校の際はお気を付けくださいませ。</p></dd>
                    </dl>
<?php
}
?>
...
<div class="main_vi">
<ul class="slider">
       <?php if (date("Ymd") <= 20181124) : ?> <!-- 表示するまでの期間をyyyymmddで記載　-->
	<?php
	if ($id == "1076000" ) {
		//けやき
	?>
	...
	<?php
		...
		//上野
	?>
	<li><a href="/<?=$room[$id][dir]?>/contact.php"><img src="../images/img-new_ueno.jpg" width="985" height="300" alt="上野マルイ教室　12月10日（月）新規開校！" class="alpha" /></a></li>
	...
	<?php
		...
		//溝口
	?>
	<li><a href="/<?=$room[$id][dir]?>/contact.php"><img src="../images/img-new_mizonokuchi.jpg" width="985" height="300" alt="マルイファミリー溝口教室　12月1日（土）新規開校！" class="alpha" /></a></li>
	<li><a href="/course/junior_pc.php" target="_blank"><img src="../images/img-main04.jpg" width="985" height="300" alt="子どもパソコン講座開講！詳しくはこちらから" class="alpha" /></a></li>
	<li><a href="/<?=$room[$id][dir]?>/certify.php"><img src="../images/img-main01.png" width="985" height="300" alt="エクセル・ワード・パワーポイントを仕事で活かす！ビジネス実践講座" class="alpha" /></a></li>
	<li><a href="/<?=$room[$id][dir]?>/mos.php"><img src="../images/img-main02.png" width="985" height="300" alt="就職・転職を有利に！資格は実力の証！MOS資格取得コース" class="alpha" /></a></li>
	<?php
	...
	<?php
		...
		//通常
	?>
	<li><a href="/<?=$room[$id][dir]?>/contact.php"><img src="../images/img-main_cp1811-1.jpg" width="985" height="300" alt="最大6000円お得な応援キャンペーン実施中！" class="alpha" /></a></li>
	<li><a href="/course/junior_pc.php" target="_blank"><img src="../images/img-main04.jpg" width="985" height="300" alt="子どもパソコン講座開講！詳しくはこちらから" class="alpha" /></a></li>
	<li><a href="/<?=$room[$id][dir]?>/certify.php"><img src="../images/img-main01.png" width="985" height="300" alt="エクセル・ワード・パワーポイントを仕事で活かす！ビジネス実践講座" class="alpha" /></a></li>
	<li><a href="/<?=$room[$id][dir]?>/mos.php"><img src="../images/img-main02.png" width="985" height="300" alt="就職・転職を有利に！資格は実力の証！MOS資格取得コース" class="alpha" /></a></li>
	<?php
	...
	?>
     ...
     <?php if (date("Ymd") >= 20181125) : ?> <!-- 表示するまでの期間をyyyymmddで記載　-->
	<?php
	if ($id == "1076000" ) {
		//けやき
	?>
...
?>
<?php
} elseif ($id == "1001135" || $id == "1001136" || $id == "6015118" ) {
	//上野・溝口・あべの
?>
<section>
	<div class="room_info">
...
<section>
	<div class="room_info">
		...
		<div class="room_info_lft">
		<dl>
			<dt><a href="../images/201811cp1.pdf" target="_blank"><img src="../images/201811cp1.jpg" width="180" alt="最大6000円お得な応援キャンペーン実施中！"></a>
<?php
if( $room[$id][sps] == "1" ) {
//SPS実施校
?>
				<a href="../images/201811cp1_ura.pdf" target="_blank"><img src="../images/201811cp1_ura.jpg" width="180" alt="全ての世代に役立つパソコンスキル"></a>
<?php
...
?>
		...
		<div class="room_info_rgt">
		<dl>
			<dt class="tk-kozuka-gothic-pr6n">最大6,000円お得な応援キャンペーン実施中！</dt>
			<dd><p>「やってみたい」が「できた！」に変わる！幅広い年齢層の方々が楽しく学ばれています。</p>
			<p>パソコン市民講座 <?=$room[$id][name]?>教室（<?=$room[$id][area]?>）では、<strong>最大6,000円お得にスタートできる</strong>「お得な応援キャンペーン」を<strong>11月24日（土）まで実施中</strong>です！<br>通常受講料1時間あたり1,500円（税別）のところ、受講スタート初月に限り最大12時間までスタート応援価格1,000円（税別）で受講ができるお得なキャンペーンですので、この機会にぜひお申込みください！</p>
