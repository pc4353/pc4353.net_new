...
<ul id="course_indlist">
    <li class="course_box cb_a"><a href="mos.php"><p class="course_boxttl">MOS資格対策講座</p>
		<img src="/course/images/bnr-course01.jpg" alt="MOS資格対策講座"><p class="course_boxtx">Microsoftの公認試験で知名度No.1！</p></a></li>
    <li class="course_box cb_b"><a href="certify.php"><p class="course_boxttl">サーティファイ講座</p>
		<img src="/course/images/bnr-course02.jpg" alt="サーティファイ講座"><p class="course_boxtx">ビジネスシーンに特化した実践的な資格！</p></a></li>
	<li class="course_box cb_c"><a href="#works"><p class="course_boxttl">仕事で役立てたい</p>
		<img src="/course/images/bnr-course03.jpg" alt="仕事で役立てたい"><p class="course_boxtx">独学で習得されてきた方に最適！</p></a></li>
		<li class="course_box cb_c"><a href="#lisence"><p class="course_boxttl">資格を取得したい</p>
		<img src="/course/images/bnr-course04.jpg" alt="資格を取得したい"><p class="course_boxtx">仕事に活かせるさらに上のスキルを身につける</p></a></li>
	<li class="course_box cb_c"><a href="#first"><p class="course_boxttl">基本操作を覚えたい</p>	
		<img src="/course/images/bnr-course05.jpg" alt="基本操作を覚えたい"><p class="course_boxtx">パソコンを使ったことがない超初心者も大歓迎！</p></a></li>
	<li class="course_box cb_c"><a href="#tb-smp"><p class="course_boxttl">タブレット・スマホ</p>
		<img src="/course/images/bnr-course06.jpg" alt="タブレット・スマホ"><p class="course_boxtx">家でも外でもシーンに合わせて便利に使おう！</p></a></li>
	<li class="course_box cb_c"><a href="#net"><p class="course_boxttl">ネットを楽しみたい</p>
		<img src="/course/images/bnr-course07.jpg" alt="ネットを楽しみたい"><p class="course_boxtx">検索のコツやショッピング<br class="pc-only">便利なサイトのご紹介</p></a></li>
	<li class="course_box cb_c"><a href="#hobby"><p class="course_boxttl">趣味を楽しみたい</p>
		<img src="/course/images/bnr-course08.jpg" alt="趣味を楽しみたい"><p class="course_boxtx">デジカメ写真の活用や年賀状作成など</p></a></li>
	<li class="course_box cb_c"><a href="junior.php"><p class="course_boxttl">小中学生のPC学習</p>
		<img src="/course/images/bnr-course09.jpg" alt="小中学生コース"><p class="course_boxtx">タッチタイピングを取得して差をつけよう！</p></a></li>
	<li class="course_box cb_c"><a href="rehire.php"><p class="course_boxttl">再雇用・再就職</p>
		<img src="/course/images/bnr-course10.jpg" alt="再雇用・再就職"><p class="course_boxtx">シニア世代の再雇用にパソコンスキル活用！</p></a></li>
</ul>
</div>
