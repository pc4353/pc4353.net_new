...
$ary = array(
	array(
		...
		"イベント・iPad",
		"読書・カエルグッズ集め・神社参拝",
		"インストラクター歴14年の経験を生かして、あなたのサポートをいたします。<br />目まぐるしく変わる世の中。変化の多いこの時代の波に乗り遅れないよう、ぜひ新しい一歩を踏み出しましょう。パソコンもタブレットも、あなたの生活をより豊かにします。私も初めは初心者でした。そして今でも学ぶことがたくさんあります。<br />パソコン・タブレットを始めようと考えている皆様。私たちが応援いたします。"
	),
	array(
		"今泉 先生",
		"インターネット・ワード",
